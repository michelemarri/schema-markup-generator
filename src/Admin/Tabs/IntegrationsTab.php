    ...
    public function render(): void
    {
        ...
        <div class="smg-tab-panel flex flex-col gap-6" id="tab-integrations">
            ...
            <?php if (class_exists('RankMath') && ($settings['integration_rankmath_enabled'] ?? true)): ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <?php
                    $this->renderCard(__('Schema Control', 'schema-markup-generator'), function () use ($settings) {
                        $this->renderToggle(
                    ...
                    $this->renderCard(__('Duplicate Prevention', 'schema-markup-generator'), function () use ($settings) {
                        ...
                        ?>
                        <div class="<?php echo $disableAll ? 'opacity-50 pointer-events-none' : ''; ?>">
                        <?php
                        $this->renderToggle(
                        ...
                        <p class="smg-text-muted text-xs mt-2">
                            ...
                            <?php esc_html_e('This option is ignored when "Disable All Rank Math Schemas" is enabled.', 'schema-markup-generator'); ?>
                        </p>
                        <?php endif;
